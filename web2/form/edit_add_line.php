    ...
    <form method="POST">
        <div class="add-line-head">
            <?php
                ...
                $from = $_GET['from'];
            ?>
            <a onclick="window.location.href='basic_edit_event.php?id=<?php echo $id; ?>&u=<?php echo $uid; ?>&e=<?php echo $eid; ?>&from=<?php echo $from; ?>'" class="close-icon"><i class="fas fa-times"></i></a>
        </div>
